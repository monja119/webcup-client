...
export default function ButtonSubmit({ children }) {
    ...
    const custom_button_sumbit = document.getElementById('custom-button-sumbit')
    var disabled = false
    const custom_canvas = document.getElementById('custom_canvas')
    const ctx = custom_canvas.getContext('2d')
    custom_canvas.width = window.innerWidth
    custom_canvas.height = window.innerHeight
    let cx = ctx.custom_canvas.width / 2
    let cy = ctx.custom_canvas.height / 2
